...
export function ChatView({ messages, onSendMessage, onStopMessage, streamingBuffer, isStreaming }: ChatViewProps) {
  ...
  const composer = (
    <div className="w-full shrink-0 px-4 pb-4 pt-2 md:px-6 md:pb-5">
  ...
  return (
    <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-hidden">
      {isEmpty ? (
        <>
          {/* Empty state: centered hero + suggestions + composer */}
          <div className="flex flex-1 items-center justify-center overflow-y-auto px-3 sm:px-4 md:px-6">
            <div className="flex w-full max-w-4xl flex-col items-center py-8 md:py-16">
